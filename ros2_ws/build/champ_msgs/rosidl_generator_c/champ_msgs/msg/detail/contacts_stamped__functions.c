...
champ_msgs__msg__ContactsStamped__create(void)
{
...
champ_msgs__msg__ContactsStamped__Sequence__init(champ_msgs__msg__ContactsStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(champ_msgs__msg__ContactsStamped)) {
      return false;
    }
  ...
  champ_msgs__msg__ContactsStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(champ_msgs__msg__ContactsStamped)) {
      return false;
    }
